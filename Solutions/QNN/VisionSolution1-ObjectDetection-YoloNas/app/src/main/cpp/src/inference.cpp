...
sample_app::StatusCode setPerfConfig(const std::string& perfLevel) {
    ...
    // -------------------------------------------------------------------------
    // Config [1]: RPC Control Latency � fixed at 100 �s for all profiles
    // -------------------------------------------------------------------------
    ...
    rpcLatencyConfig.rpcControlLatencyConfig   = 100;  // �s

    // -------------------------------------------------------------------------
    // Config [2]: RPC Polling Time � 9999 �s for high-perf, 0 for power-saver
    // -------------------------------------------------------------------------
